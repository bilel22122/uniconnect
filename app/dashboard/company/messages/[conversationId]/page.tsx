    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                ...
                // 2. Get Conversation Details (Student info)
                ...
                // Safe cast since we know the structure from the query
                // Safe cast since we know the structure from the query
                // Using any to bypass complex joined type definitions if needed, 
                // but try to be safe with the Profile type.
                if (conversationData) {
                    setConversation(conversationData as unknown as Conversation);
                    if (conversationData.student) {
                        setStudent(conversationData.student as unknown as Profile);
                    }
                }
    ...
    const handleSendMessage = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            if (error) {
                ...
                // Ideally show error state or restore input
            } else {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-64px)] bg-white">
            ...
            <div className="flex items-center gap-4 px-6 py-4 border-b border-gray-100 bg-white z-10">
                <Link href="/dashboard/company/messages" className="p-2 hover:bg-gray-100 rounded-full transition-colors text-gray-500">
                ...
                <div>
                    <h2 className="font-bold text-gray-900">{student?.full_name || 'Student'}</h2>
