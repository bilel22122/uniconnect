            ...
            <div className="bg-white shadow-sm border-b border-slate-200">
                ...
                <div className="px-8 pb-8">
                    <div className="relative -mt-16 flex flex-col md:flex-row items-start md:items-end gap-6">
                        {/* Avatar */}
                        <div className="w-32 h-32 rounded-full border-4 border-white bg-slate-100 shadow-md overflow-hidden flex items-center justify-center flex-shrink-0">
                            {profile.photo_url ? (
                        ...
                        <div className="flex-1 pb-2">
                            ...
                            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm text-slate-500">
                                ...
                                {profile.mobility && (
                                    <span className="flex items-center gap-1.5 bg-blue-50 text-blue-700 px-2 py-0.5 rounded-md text-xs font-semibold uppercase tracking-wide">
                                        {profile.mobility}
                                    </span>
                                )}
                            </div>
                            ...
                            {profile.portfolio_url && (
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <a href={profile.portfolio_url} target="_blank" className="text-blue-600 hover:underline break-all">
                                            View Website
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        ...
                        <div className="pl-2 border-l-2 border-slate-100 ml-2 space-y-6">
                            <div className="relative pl-6">
                                <div className="absolute -left-[1.3rem] top-1 w-3 h-3 rounded-full bg-blue-600 border-2 border-white shadow-sm" />
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        ...
                        {!profile.part_time_jobs && !profile.freelance_projects ? (
                            <div className="text-center py-8 text-slate-400 bg-slate-50 rounded-lg border border-dashed border-slate-200">
                                ...
                                <Link href="/dashboard/student/profile/edit" className="ml-1 text-blue-600 hover:underline">Add some?</Link>
                            </div>
                        ) : (
